...
export default function Rewards(){
    return (
        ...
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <p>
                <span className="text-3xl sm:text-2xl md:text-2xl lg:text-4xl font-light mb-2 sm:mb-4">
                    {/* bg-gradient-to-b from-orange-400 via-amber-600 bg-clip-text text-transparent */}
        ...
        {/* PULSE BACKGROUND */}
        {/* Top Part
        <div className="absolute top-55 right-4 sm:right-50 w-48 sm:w-70 h-48 sm: h-72 bg-orange-500/40 rounded-full blur-3xl animate-pulsed delay-300"></div>
        <div className="absolute top-25 left-10 sm:left-5 w-64 sm:w-90 sm:h-64 sm:h-96 bg-orange-500/40 rounded-full blur-3xl animate-pulse delay-1000"></div>
        Bottom Part
        <div className="absolute bottom-15 right-10 sm:right-10 w-64 sm:w-96 sm:h-64 sm:h-96 bg-orange-500/40 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute bottom-75 left-50 sm:right-10 w-64 sm:w-96 sm:h-64 sm:h-96 bg-orange-500/40 rounded-full blur-3xl animate-pulse delay-300"></div> */}
        {/* FEATURES GRID */}
