...
const ParallaxBackground = () => {
    ...
    return (
        <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none select-none opacity-60">
            ...
            <div className="absolute top-[-10%] right-[-10%] w-[600px] h-[600px] bg-gradient-to-br from-lime-100/40 to-emerald-100/40 rounded-full blur-3xl animate-pulse" />
            <div className="absolute bottom-[-10%] left-[-10%] w-[700px] h-[700px] bg-gradient-to-tr from-yellow-100/40 to-orange-100/40 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
        </div>
    );
};
...
const PlayerRow = ({ user, rank, delay, activeSort }) => {
    ...
    return (
        <div
            className="group relative flex items-center gap-3 sm:gap-4 p-4 mb-3 bg-white rounded-2xl border-2 border-stone-100 hover:border-stone-900 transition-all duration-200 hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_#1c1917] hover:z-10 cursor-none"
        ...
        <div className={`min-h-screen ${THEME.bg} font-sans pb-28 overflow-x-hidden selection:bg-lime-200 cursor-none`}>
            ...
            <main className="max-w-4xl mx-auto px-4 mt-8 relative z-10">
                <div className="text-center mb-8">
                    <h1 className="text-5xl md:text-7xl font-black text-stone-900 mb-4 drop-shadow-sm tracking-tight transition-all duration-700">
                        {availableTabs.find(t => t.id === activeTabId)?.label || 'Leaderboard'}
                    </h1>
                    <p className="text-stone-500 font-bold text-xl transition-all duration-700 delay-200">
                ...
                <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 w-full max-w-lg px-4">
                    <div className="bg-stone-900 text-white p-4 rounded-3xl shadow-2xl flex items-center justify-between border-4 border-stone-800">
